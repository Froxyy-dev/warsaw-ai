  ...
  return (
    <main className="min-h-screen w-full bg-[#0a0a0a]">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,2.6fr)_minmax(0,1fr)] gap-4 lg:gap-6">
          {/* Chat Panel */}
          ...
          <div className="w-full space-y-6 lg:max-h-[calc(100vh-180px)] lg:overflow-y-auto lg:pr-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
